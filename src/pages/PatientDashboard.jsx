    ...
    if (symptomForAIDiagnosis.symptom.trim()) {
          try {
           console.log("SYMPTOM:",symptomForAIDiagnosis)
            // const token = localStorage.getItem("token");
           await AIService.getAIRecommendation(symptomForAIDiagnosis).then((response) => {
                  ...
                  {symptomDailogFormAISubmitted ? ((
                   (AIResponse.observation !=="") ? (
                    <>
                      ...
                      <p> recommended Specialization :  </p>
                      {AIResponse.recommendedSpecialization}
<center>
                      <Button
                  ...
                  <center>   <Button
                    ...
                    <>
                      <textarea
                        ...
                        onChange={(e) =>
                          setSymptomForAIDiagnosis({...symptomForAIDiagnosis, symptom: e.target.value})
                        }
                        rows="4"
                        cols="30"
                      ></textarea>
            ...
            <div className="container4">
              <div className="upcomingAppCard">
                <div className="cardActionArea">
                  ...
                  <div className="cardContent">
                    <h5 className="cardTitle">Appointment with doctor X</h5>
